...
import com.example.mobile_development_2_2.ResultOfCharactersQueue
...
class MainMenuViewModel : ViewModel() {
    ...
    fun fetchCharactersRequest(){
        RickAndMortyApi.instance.getAllCharacters(_currentPage).enqueue(object : Callback<RickAndMortyCharactersData> {
